...
train, test = train_test_split(dataframe, test_size=0.3, random_state = 3)
train, val = train_test_split(train, test_size=0.3, random_state = 3) #, random_state = 3
...
# Numeric features.
num_features = [
               'level_0_damage_dealt', 'level_0_damage_dealt_range', 'level_0_damage_dealt_close',
                'level_0_health_lost', 
              ...
              #  'level_0_ranged_enem_killed', # THIS value is always 0 because there are no ranged enemies in level 0
                'level_0_close_enem_killed', 'level_0_movements', 'level_0_health_regen', 'level_0_turns',
                'level_0_coins', 'level_0_points', 'level_0_prior_deaths', 'level_1_damage_dealt',
                'level_1_damage_dealt_range', 'level_1_damage_dealt_close', 'level_1_health_lost',
              ...
              #  'level_1_close_enem_killed',  # THIS value is always 0 because there are no close combat enemies in level 1
                ...
                'level_2_damage_dealt', 'level_2_damage_dealt_range', 'level_2_damage_dealt_close',
                'level_2_health_lost', 
              ...
              #  'level_2_kills',
                ...
                'level_2_prior_deaths', 'level_3_damage_dealt', 'level_3_damage_dealt_range',
                'level_3_damage_dealt_close', 'level_3_health_lost', 
              ...
              #  'level_3_kills', 
                ...
                'level_3_turns', 'level_3_coins', 'level_3_points', 'level_3_prior_deaths', 'level_4_damage_dealt',
                'level_4_damage_dealt_range', 'level_4_damage_dealt_close', 'level_4_health_lost',
...
x = tf.keras.layers.Dense(16, activation="softmax")(all_features)
...
model.compile(optimizer='adam',
              ...
              metrics=["accuracy"])
model.load_weights("./training/cp-0042.ckpt")
